package com.example.demo.pingshi.email;
...
public class DoSend {
	...
	private String from = "***@163.com"; // 发件人邮箱地址
	private String user = "**@163.com"; // 发件人称号，同邮箱地址
	...
	public static void main(String[] args) { // 做测试用
		...
		ds.sendMail("**@163.com", "你好，这是一封测试邮件，无需回复。", "测试邮件");
	}
}
